...
Follow initialization steps in `/.github/instructions/reference/product-management/[PRODUCT_MANAGEMENT_TOOL].md`.
...
- multiSelect: false
- options:
  - label: "account", description: "Tenant and user management system"
...
**Create the PRD content following the [example PRD structure](/.github/instructions/reference/samples/example-prd.md):**
...
Follow your [PRODUCT_MANAGEMENT_TOOL]-specific guide at `/.github/instructions/reference/product-management/[PRODUCT_MANAGEMENT_TOOL].md` to understand how to create items based on the PRD.
