...
public sealed class SetGithubConfigCommand : Command
{
    ...
    public SetGithubConfigCommand() : base("set-github-config", "Configure GitHub repository variables and secrets for external integrations like Google OAuth")
    {
        SetAction(_ => Execute());
    }
