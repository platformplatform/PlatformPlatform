...
public class OpenTelemetryEnricher(IExecutionContext executionContext)
{
    public void Apply()
    {
        ...
        Activity.Current.SetTag("tenant.subscription_plan", executionContext.UserInfo.SubscriptionPlan?.ToString());
        ...
        Activity.Current.SetTag("feature_flags", string.Join(",", executionContext.UserInfo.FeatureFlags));
    }
}
