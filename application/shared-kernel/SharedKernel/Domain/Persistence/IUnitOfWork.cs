namespace PlatformPlatform.SharedKernel.Domain.Persistence;
...
///     Use to add, update, and delete aggregates to a unit of work. When the unit of work is committed, the changes are
