...
using PlatformPlatform.SharedKernel.Infrastructure.Services;

namespace PlatformPlatform.SharedKernel.Infrastructure;
...
public static class InfrastructureConfiguration
{
    ...
    public static IServiceCollection ConfigureInfrastructureServices<T>(
        this IServiceCollection services,
        Assembly assembly
    )
        where T : DbContext
    ...
    public static async Task ApplyMigrationsAsync<T>(this IServiceProvider services) where T : DbContext
    {
        ...
        var logger = loggerFactory.CreateLogger(nameof(InfrastructureConfiguration));
