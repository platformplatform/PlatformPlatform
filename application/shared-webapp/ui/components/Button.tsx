...
const button = tv({
  ...
  variants: {
    variant: {
      ...
      outline:
        "border border-input pressed:bg-hover-background text-accent-foreground pressed:opacity-80 hover:bg-hover-background hover:text-accent-foreground/90",
      ghost:
        "pressed:bg-hover-background text-accent-foreground pressed:opacity-80 hover:bg-hover-background hover:text-accent-foreground/90",
