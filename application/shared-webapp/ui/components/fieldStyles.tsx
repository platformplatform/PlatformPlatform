/**
 * Legacy field styles for React Aria components.
 * These are used by components that haven't been migrated to ShadCN yet.
 */
...
export const fieldGroupStyles = tv({
  extend: focusRing,
  base: "group flex h-10 items-center overflow-hidden rounded-md border bg-input-background forced-colors:bg-[Field]",
