    ...
    public async Task<string> ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        foreach (var tenantId in tenantIds)
        {
            ...
            await dbContext.Database.ExecuteSqlAsync(
                $"""
                 INSERT INTO Subscriptions (TenantId, Id, CreatedAt, ModifiedAt, [Plan], ScheduledPlan, StripeCustomerId, StripeSubscriptionId, CurrentPeriodEnd, CancelAtPeriodEnd, FirstPaymentFailedAt, LastNotificationSentAt, PaymentTransactions, PaymentMethod)
