...
public sealed class ElectricEndpoints : IEndpoints
{
    ...
    private static readonly Dictionary<string, ShapeTableConfig> AllowedTables = new()
    {
        ...
        ["feature_flags"] = new ShapeTableConfig("tenant_id", ["id", "feature_flag_key", "tenant_id", "user_id", "enabled_at", "disabled_at", "rollout_bucket_start", "rollout_bucket_end", "configurable_by_tenant", "configurable_by_user"], UserScopedColumn: "user_id", IncludeNullRows: true)
    };
