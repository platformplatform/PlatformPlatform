...
public sealed class FeatureFlagEndpoints : IEndpoints
{
    ...
    public void MapEndpoints(IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{flagKey}/users", async Task<ApiResult<GetFlagUsersResponse>> (string flagKey, [AsParameters] GetFlagUsersQuery query, IMediator mediator)
        ...
        group.MapDelete("/{flagKey}/user-override", async Task<ApiResult> (string flagKey, string userId, long tenantId, IMediator mediator)
