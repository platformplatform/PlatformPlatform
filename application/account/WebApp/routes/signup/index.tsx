...
export function StartSignupForm() {
  ...
  const handleGoogleSignup = () => {
    ...
    const signupUrl = locale
      ? `/api/account/authentication/${ExternalProviderType.Google}/signup/start?locale=${encodeURIComponent(locale)}`
      : `/api/account/authentication/${ExternalProviderType.Google}/signup/start`;
