...
export default function InvitationBanner() {
  ...
  useEffect(() => {
    if (hasPendingInvitations) {
      document.documentElement.style.setProperty("--invitation-banner-height", `${BANNER_HEIGHT}px`);
    } else {
      document.documentElement.style.setProperty("--invitation-banner-height", "0px");
    }
    return () => {
      document.documentElement.style.setProperty("--invitation-banner-height", "0px");
    };
