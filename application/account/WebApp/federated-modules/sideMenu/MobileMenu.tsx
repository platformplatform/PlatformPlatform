...
function MobileMenuHeader({
  ...
  const logoutMutation = api.useMutation("post", "/api/account/authentication/logout", {
    onMutate: async () => {
  ...
  return (
    ...
    >
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-1">
        ...
        {/* Account Selector */}
        <div className="-mx-3">
          <AccountSelector variant="mobile-menu" onShowInvitationDialog={onShowInvitationDialog} />
        </div>
