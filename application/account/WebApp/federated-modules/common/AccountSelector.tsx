...
export default function AccountSelector({ onShowInvitationDialog, variant = "default" }: AccountSelectorProps = {}) {
  ...
  const { data: tenantsResponse, isLoading, refetch } = api.useQuery("get", "/api/account/tenants");
