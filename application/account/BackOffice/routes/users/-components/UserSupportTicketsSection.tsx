...
interface UserSupportTicketsSectionProps {
  userId: string;
}
  ...
  return (
    <section className="flex flex-col gap-3">
      <div className="text-sm text-muted-foreground">
        <Trans>Every support ticket this user has filed, across all of their accounts.</Trans>
      </div>
      {isLoading ? (
        ...
        <Empty className="border bg-card">
          <EmptyHeader>
            ...
            <EmptyDescription>
              <Trans>This user has not filed any support tickets.</Trans>
            </EmptyDescription>
          </EmptyHeader>
        </Empty>
      ) : (
