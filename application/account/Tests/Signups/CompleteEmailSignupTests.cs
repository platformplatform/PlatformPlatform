...
using PlatformPlatform.Account.Features.Tenants.EventHandlers;
...
public sealed class CompleteEmailSignupTests : EndpointBaseTest<AccountDbContext>
{
    ...
    public async Task CompleteSignup_WhenValid_ShouldCreateTenantAndOwnerUser()
    {
        ...
        var response = await AnonymousHttpClient
            .PostAsJsonAsync($"/api/account/authentication/email/signup/{emailConfirmationId}/complete", command);
    ...
    public async Task CompleteSignup_WhenSignupNotFound_ShouldReturnNotFound()
    {
        ...
        // Act
        var response = await AnonymousHttpClient
            .PostAsJsonAsync($"/api/account/authentication/email/signup/{invalidEmailConfirmationId}/complete", command);
    ...
    public async Task CompleteSignup_WhenSignupAlreadyCompleted_ShouldReturnBadRequest()
    {
        ...
        await AnonymousHttpClient.PostAsJsonAsync($"/api/account/authentication/email/signup/{emailConfirmationId}/complete", command);
