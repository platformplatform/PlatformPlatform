...
test.describe("@smoke", () => {
   ...
   * - Permission enforcement (Member cannot access admin routes)
  ...
  test("should handle federated navigation between main and account SCS with proper route rendering", async ({
    ...
    await step("Enter verification code & verify redirect to home (cross-SCS navigation)")(async () => {
    ...
    await step("Navigate to account settings & update account name")(async () => {
    ...
    await step("Navigate to subscription page & verify subscription page renders")(async () => {
    ...
    // === BACK TO MAIN SCS ===
    await step("Navigate back to home & verify cross-SCS navigation to main")(async () => {
    ...
    await step("Login as member & verify redirect to home (cross-SCS navigation)")(async () => {
      await page.goto("/login");
      await page.getByRole("textbox", { name: "Email" }).fill(member.email);
    ...
    await step("Navigate to subscription as member & verify access denied")(async () => {
