  ...
  return (
    <div className="mt-6 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        <Button variant="destructive" onClick={() => setIsDeleteModalOpen(true)} className="w-fit">
          <Trash2 />
    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          {isOwner && (
            <Button type="submit" className="mt-4" disabled={updateCurrentTenantMutation.isPending}>
