    ...
    <div className="relative flex w-full outline outline-0 border border-neutral-200 rounded">
      <RACInput
        ...
        className={composeTailwindRenderProps(
          props.className,
          "px-2 py-1.5 flex-1 w-full rounded bg-white dark:bg-zinc-900 text-sm text-gray-800 dark:text-zinc-200 disabled:text-gray-200 dark:disabled:text-zinc-600"
        )}
      />
