...
test.describe("Localization Flow", () => {
  test.describe("@comprehensive", () => {
    test("should handle language changes across signup, authentication, and logout flows", async ({ page }) => {
      ...
      await step("Login with English interface & verify language resets to user's saved preference (Danish)")(
        async () => {
    ...
    test("should handle language persistence across different user sessions", async ({ browser }) => {
      ...
      await step("Complete signup for first user with Danish language & verify language preference saved")(async () => {
      ...
      await step("Login first user in new session & verify Danish language is restored from database")(async () => {
      ...
      await step("Login second user in new session & verify English language is restored from database")(async () => {
