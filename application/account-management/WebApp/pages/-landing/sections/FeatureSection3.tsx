  ...
  return (
    <>
      <div className="flex flex-col md:gap-8 gap-4">
        <h3 className="text-gray-900 text-2xl font-semibold">Sign up and Sign in - built right in</h3>
        <p className="text-slate-600 text-md md:text-xl font-normal">
      ...
      <div className="flex flex-col md:gap-8 gap-4">
        <h3 className="text-gray-900 text-2xl font-semibold">User Management and Multi-tenancy</h3>
        <p className="text-slate-600 text-md md:text-xl font-normal">
      ...
      <div className="flex flex-col md:gap-8 gap-4">
        <h3 className="text-gray-900 text-2xl font-semibold">Dark Side of the Force</h3>
        <p className="text-slate-600 text-md md:text-xl font-normal">
