...
[PublicAPI]
public sealed record StartExternalLoginCommand(ExternalProviderType ProviderType, string? ReturnPath, string? Locale) : ICommand, IRequest<Result<StartExternalLoginResponse>>;
