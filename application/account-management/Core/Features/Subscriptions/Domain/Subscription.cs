...
public sealed class Subscription : AggregateRoot<SubscriptionId>, ITenantScopedEntity
{
    ...
    public void SyncFromStripe(SubscriptionPlan plan, SubscriptionPlan? scheduledPlan, string? stripeSubscriptionId, DateTimeOffset? currentPeriodEnd, bool cancelAtPeriodEnd, ImmutableArray<PaymentTransaction> paymentTransactions)
    {
        Plan = plan;
    ...
    {
        return StripeSubscriptionId is not null && Plan != SubscriptionPlan.Trial && !CancelAtPeriodEnd;
    }
}
