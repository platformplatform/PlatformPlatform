...
public sealed class RestoreUserTests : EndpointBaseTest<AccountManagementDbContext>
{
    [Fact]
    public async Task RestoreUser_WhenOwnerRestoresDeletedUser_ShouldSucceed()
    {
        ...
        // Act
        var response = await AuthenticatedOwnerHttpClient.PostAsync($"/api/account-management/users/{deletedUserId}/restore", null);
    ...
    public async Task RestoreUser_WhenMember_ShouldReturnForbidden()
    {
        ...
        // Act
        var response = await AuthenticatedMemberHttpClient.PostAsync($"/api/account-management/users/{deletedUserId}/restore", null);
    ...
    public async Task RestoreUser_WhenUserNotFound_ShouldReturnNotFound()
    {
        ...
        // Act
        var response = await AuthenticatedOwnerHttpClient.PostAsync($"/api/account-management/users/{nonExistentUserId}/restore", null);
    ...
    public async Task RestoreUser_WhenUserNotDeleted_ShouldReturnNotFound()
    {
        ...
        // Act
        var response = await AuthenticatedOwnerHttpClient.PostAsync($"/api/account-management/users/{activeUserId}/restore", null);
