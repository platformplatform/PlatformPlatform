...
public sealed class BulkPurgeUsersTests : EndpointBaseTest<AccountManagementDbContext>
{
    [Fact]
    public async Task BulkPurgeUsers_WhenOwnerDeletesMultipleDeletedUsers_ShouldPermanentlyDeleteAllSpecifiedUsers()
    {
        ...
        var response = await AuthenticatedOwnerHttpClient.PostAsJsonAsync("/api/account-management/users/deleted/bulk-purge", command);
    ...
    public async Task BulkPurgeUsers_WhenMember_ShouldReturnForbidden()
    {
        ...
        var response = await AuthenticatedMemberHttpClient.PostAsJsonAsync("/api/account-management/users/deleted/bulk-purge", command);
