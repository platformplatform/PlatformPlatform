...
public sealed class GetDeletedUsersTests : EndpointBaseTest<AccountManagementDbContext>
{
    [Fact]
    public async Task GetDeletedUsers_WhenOwner_ShouldReturnDeletedUsers()
    {
        ...
        // Act
        var response = await AuthenticatedOwnerHttpClient.GetAsync("/api/account-management/users/deleted");
    ...
    {
        // Act
        var response = await AuthenticatedMemberHttpClient.GetAsync("/api/account-management/users/deleted");
