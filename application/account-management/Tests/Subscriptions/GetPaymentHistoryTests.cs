...
public sealed class GetPaymentHistoryTests : EndpointBaseTest<AccountManagementDbContext>
{
    [Fact]
    public async Task GetPaymentHistory_WhenTransactionsExist_ShouldReturnPaginatedHistory()
    {
        ...
        var transactionsJson = $$"""[{"Id":"{{transactionId}}","Amount":29.99,"Currency":"usd","Status":"Succeeded","StripePaymentIntentId":"pi_test","Date":"2026-01-01T00:00:00+00:00","FailureReason":null,"InvoiceUrl":"https://invoice.stripe.com/test"}]""";
        ...
        // Act
        var response = await AuthenticatedOwnerHttpClient.GetAsync("/api/account-management/subscriptions/payment-history");
