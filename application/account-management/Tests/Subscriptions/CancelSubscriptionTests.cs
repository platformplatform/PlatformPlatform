...
public sealed class CancelSubscriptionTests : EndpointBaseTest<AccountManagementDbContext>
{
    [Fact]
    public async Task CancelSubscription_WhenActiveSubscription_ShouldSucceed()
    {
        ...
        // Act
        var response = await AuthenticatedOwnerHttpClient.PostAsJsonAsync("/api/account-management/subscriptions/cancel", command);
    ...
    public async Task CancelSubscription_WhenTrialSubscription_ShouldReturnBadRequest()
    {
        ...
        // Assert
        await response.ShouldHaveErrorStatusCode(HttpStatusCode.BadRequest, "Cannot cancel a Trial subscription.");
    ...
    public async Task CancelSubscription_WhenNonOwner_ShouldReturnForbidden()
    {
        ...
        // Act
        var response = await AuthenticatedMemberHttpClient.PostAsJsonAsync("/api/account-management/subscriptions/cancel", command);
