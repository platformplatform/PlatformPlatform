...
public sealed class HandleStripeWebhookTests : EndpointBaseTest<AccountManagementDbContext>
{
    private const string WebhookUrl = "/api/account-management/subscriptions/stripe-webhook";
    ...
    {
        // Arrange
        InsertSubscription(plan: nameof(SubscriptionPlan.Trial));
        TelemetryEventsCollectorSpy.Reset();
