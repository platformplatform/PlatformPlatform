...
public sealed class CreateCheckoutSessionTests : EndpointBaseTest<AccountManagementDbContext>
{
    [Fact]
    public async Task CreateCheckoutSession_WhenTrialSubscription_ShouldReturnCheckoutUrl()
    {
        // Arrange
        ...
        var command = new CreateCheckoutSessionCommand(SubscriptionPlan.Standard, "https://localhost:9000/subscription/success", "https://localhost:9000/subscription/cancel");
        TelemetryEventsCollectorSpy.Reset();

        // Act
        var response = await AuthenticatedOwnerHttpClient.PostAsJsonAsync("/api/account-management/subscriptions/checkout", command);
    ...
    public async Task CreateCheckoutSession_WhenActiveSubscriptionExists_ShouldReturnBadRequest()
    {
        ...
        var command = new CreateCheckoutSessionCommand(SubscriptionPlan.Premium, "https://localhost:9000/subscription/success", "https://localhost:9000/subscription/cancel");
        TelemetryEventsCollectorSpy.Reset();
    ...
    public async Task CreateCheckoutSession_WhenNonOwner_ShouldReturnForbidden()
    {
        ...
        // Act
        var response = await AuthenticatedMemberHttpClient.PostAsJsonAsync("/api/account-management/subscriptions/checkout", command);
