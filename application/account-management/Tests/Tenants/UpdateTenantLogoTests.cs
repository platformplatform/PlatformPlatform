...
public sealed class UpdateTenantLogoTests : EndpointBaseTest<AccountManagementDbContext>
{
    ...
    public async Task UpdateTenantLogo_WhenMemberUser_ShouldReturnForbidden()
    {
        ...
        // Act
        var response = await AuthenticatedMemberHttpClient.PostAsync("/api/account-management/tenants/current/update-logo", formData);
