...
az storage account create --name $storageaccount --resource-group $resourcegroup --location $location --sku Standard_LRS --min-tls-version TLS1_2 --tags managed-by=powershell environment=$environment
