...
///     determine if the input is valid or not. If the input is not valid, the <see cref="ValidationResult" /> object
...
public static partial class ValidationUtils
{
    ...
    public static ValidationResult IsStringValid(string name, string input, string regEx, int minLength, int maxLength,
        string errorMessage)
    {
    ...
    public static ValidationResult IsValidPhone(string name, string? input)
    {
    ...
    public static ValidationResult IsValidEmail(string name, string input)
    {
    ...
    private static ValidationResult GetResult(string name, bool success, string errorMessage)
    {
        return success
            ? ValidationResult.Success()
            : ValidationResult.Failure(name, errorMessage);
    }
}