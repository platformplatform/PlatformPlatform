...
**Evidence-Based Reviews**: Every finding must be backed by rules in `/.windsurf/rules/end-to-end-tests/end-to-end-tests.md` or established patterns in the codebase.
