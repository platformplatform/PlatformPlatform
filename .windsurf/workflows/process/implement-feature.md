...
For EACH [story]:
  ...
  3. For EACH [task] title in your [story], match it to the actual [task] identifier from [PRODUCT_MANAGEMENT_TOOL]
...
### Step 5: Collapse Stories and Update Status
...
**Sequential Mode**:
```
1. Load all 3 [stories], extract 11 [tasks] total
