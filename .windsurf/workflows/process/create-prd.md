...
Follow initialization steps in `/.windsurf/rules/product-management/[PRODUCT_MANAGEMENT_TOOL].md`.
...
Follow your [PRODUCT_MANAGEMENT_TOOL]-specific guide at `/.windsurf/rules/product-management/[PRODUCT_MANAGEMENT_TOOL].md` to understand how to create items based on the PRD.
