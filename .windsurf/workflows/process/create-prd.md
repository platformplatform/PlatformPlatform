...
Follow initialization steps in `/.windsurf/reference/product-management/[PRODUCT_MANAGEMENT_TOOL].md`.
...
**Create the PRD content following the [example PRD structure](/.windsurf/reference/samples/example-prd.md):**
...
Follow your [PRODUCT_MANAGEMENT_TOOL]-specific guide at `/.windsurf/reference/product-management/[PRODUCT_MANAGEMENT_TOOL].md` to understand how to create items based on the PRD.
