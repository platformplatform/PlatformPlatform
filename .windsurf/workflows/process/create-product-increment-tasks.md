---
description: Workflow for create technical tasks for a product increment based on a prd
...
- [Backend for team management](/.windsurf/samples/1-backend-sample.md)
- [Frontend for team management](/.windsurf/samples/2-frontend-sample.md)
