...
1. Explicit rules from `.windsurf/rules/` files, OR
...
**STEP 11**: MANDATORY: Call CompleteWork
...
- **Rule/Pattern**: [Reference to .windsurf/rules/X.md or pattern from codebase]
