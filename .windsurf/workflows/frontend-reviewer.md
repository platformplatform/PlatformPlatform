---
description: Workflow for use this agent when working in coordinator mode after completing frontend implementation tasks with prds and product increments. when acting as coordinator, this agent must be called for frontend code quality review to ensure proper review delegation and tracking.
