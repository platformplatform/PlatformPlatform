...
1. Always start new changes by writing new test cases (or change existing tests)—consult [API Tests](/.windsurf/rules/backend/api-tests.md) for details
