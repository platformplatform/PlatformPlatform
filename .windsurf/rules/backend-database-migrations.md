...
5. Use standard SQL Server naming conventions:
   - Table names should be plural (e.g., `Users`, not `User`).
   - Column names should match the C# property names.
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                LastSeenDate = table.Column<DateTune>("datetime", nullable: true), // ❌ DON'T: use datetime
...
### Example 2 - Determining Column Sizes from Command Validators
...
public sealed class UpdateUserValidator : AbstractValidator<UpdateUserCommand>
{
    ...
    {
        RuleFor(x => x.Title).MaximumLength(50); // ✅ DO: Use column sizes based on command validators
    }
}

// Corresponding migration:
[DbContext(typeof(AccountManagementDbContext))]
[Migration("20250507141500_AddUserTitle")]
public sealed class AddUserTitle : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.AddColumn<string>("Title", "Users", "nvarchar(50)", nullable: true); // ✅ DO: Match column size to validator
    }
}
```
