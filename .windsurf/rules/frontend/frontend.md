...
4. Build and format your changes:
   - After each minor change, use the **build MCP tool** for frontend to format your code. See [Tools](/.windsurf/rules/tools.md) for details.
   - This ensures consistent code style across the codebase.

5. Verify your changes:
   - When a feature is complete, use the **check MCP tool** for frontend to verify your changes.
   - This runs build, format, and check in that order.
