...
description: General-purpose engineer for direct user collaboration on any task. Works directly by default, can delegate to sub-agents when the task benefits from parallel work or specialized roles.
tools: *
color: green
---
