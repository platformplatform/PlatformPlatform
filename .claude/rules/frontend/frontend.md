...
4. Build and format your changes:
   - After each minor change, use `mcp__platformplatform-developer-cli__build(BuildTarget.FrontendOnly)` to format your code. See [Tools](/.claude/rules/tools.md) for details.
