...
internal interface IBadLoginRepository : ICrudRepository<Login, LoginId> // ❌ DON'T: Do not make repositories internal
{
    Task<LoginDto> GetDto(LoginId id); // ❌ DON'T: Return DTOs from repositories, mape entities in the query
}
