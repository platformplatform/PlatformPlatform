---
description: Create technical tasks for all Product Increments in a PRD
argument-hint: Path to PRD file (e.g., ".workspace/task-manager/2025-01-15-feature/prd.md")
---
...
- [Backend for team management](/.claude/samples/1-backend-sample.md)
- [Frontend for team management](/.claude/samples/2-frontend-sample.md)
