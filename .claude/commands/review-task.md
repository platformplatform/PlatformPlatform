...
**Step 9. Create response file**:
   ...
   - **IMPORTANT**: Use descriptive response file names with Sentence-case for better activity display:
     * Format: `NNNN.{agent-type}.response.Sentence-case-review-description.md`
     * Example: `0001.backend-reviewer.response.Review-team-aggregate-found-3-critical-issues.md`
     * Use Sentence-case-with-dashes (only first word capitalized) so the activity display shows "Review team aggregate found 3 critical issues"
