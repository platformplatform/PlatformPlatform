...
2. Understand the core DDD concepts:
   ...
   - Repositories add, get, update, and remove aggregates—see [Repositories](/.agent/rules/backend/repositories.md)
...
4. For Aggregates:
   ...
   - Create a strongly typed ID—see [Strongly Typed IDs](/.agent/rules/backend/strongly-typed-ids.md)
