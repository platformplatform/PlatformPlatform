...
Follow initialization steps in `/.agent/reference/product-management/[PRODUCT_MANAGEMENT_TOOL].md`.
...
**Create the PRD content following the [example PRD structure](/.agent/reference/samples/example-prd.md):**
...
Follow your [PRODUCT_MANAGEMENT_TOOL]-specific guide at `/.agent/reference/product-management/[PRODUCT_MANAGEMENT_TOOL].md` to understand how to create items based on the PRD.
