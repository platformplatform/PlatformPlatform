...
When writing or updating `.agent/workflows/process/**` files, system prompts, agent definitions, or any workflow documentation:
...
**Before making ANY change to `.agent/workflows/process/**` files**:
...
- `.agent/agentic-workflow/system-prompts/*.txt` — Agent behavior and rules
- `.agent/agents/*.md` — Agent definitions for Task tool (proxy agents)
- `.agent/workflows/**/*.md` — Slash command workflows
...
### For Workflow Files (.agent/workflows/process/**)
